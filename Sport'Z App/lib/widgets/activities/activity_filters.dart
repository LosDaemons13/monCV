...
class ActivityFilters extends StatefulWidget {
  Map filters = {};
  ActivityFilters({Key? key, required this.filters}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return ActivityFiltersState();
  }
}

class ActivityFiltersState extends State<ActivityFilters> {
  @override
  void initState() {
    super.initState();
    populateActivities();
  ...
  populateActivities() async {
    Future<Map> map = selectActivitiesFilter(
        FirebaseAuth.instance.currentUser!.uid, widget.filters);
    setState(() {
      activities = map;
    });
  }
