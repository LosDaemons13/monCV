...
class ActivitiesCategory extends StatefulWidget {
  ActivitiesCategory({Key? key, required this.i}) : super(key: key);
  int i;

  @override
  State<ActivitiesCategory> createState() => _ActivitiesCategoryState();
}

class _ActivitiesCategoryState extends State<ActivitiesCategory> {
  late Future<Map> activities;
  @override
  void initState() {
    super.initState();
    int a = widget.i;
    activities = selectActivitiesByCategory(a);
  }
