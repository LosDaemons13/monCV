...
import 'package:projet_sport_z/widgets/activities/activity_filters.dart';
...
class FiltersResults extends StatefulWidget {
  final Map filters;
  FiltersResults({Key? key, required this.filters}) : super(key: key);

  @override
  _FiltersResultsState createState() => _FiltersResultsState();
}

class _FiltersResultsState extends State<FiltersResults> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        content: Padding(
          ...
          child: ActivityFilters(filters: widget.filters),
        ),
      )),
